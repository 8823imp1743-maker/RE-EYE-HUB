...
import funnelEventHandler from './api/funnel-event.js';
import funnelStatsHandler from './api/funnel-stats.js';
...
mountApiPath('/funnel-event', funnelEventHandler);
mountApiPath('/funnel-stats', funnelStatsHandler);
